    ...
    <el-card>
      <el-container>
        <el-header style="font-size: 30px">
          <el-row :gutter="20">
            <el-col :span="8">
              <i class="el-icon-back" title="返回" style="cursor: pointer" @click="goBack" />
              <span style="margin: 0px 10px"><el-divider direction="vertical" /></span>
              <span>计划详情</span>
            </el-col>
        ...
        <el-main>
          <el-form label-position="left" label-width="80px" style="white-space: pre-wrap;">
            ...
            <el-form-item v-if="!editorStatus" label="子计划">
              <el-row :gutter="20">
                <el-col v-for="item in children" :key="item.id" :span="7" style="margin-bottom: 20px;">
