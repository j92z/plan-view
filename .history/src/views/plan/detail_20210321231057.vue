      ...
      <el-container>
        <el-header style="font-size: 30px">
          <el-row>
            ...
            <el-col :span="1" :offset="15" style="font-size: 30px">
              <span><i class="el-icon-edit" :command="edit" />编辑</span>
              <span v-if="children.length === 0" ><i class="el-icon-delete" />删除</span>
              <span v-else style="color: gray"><i class="el-icon-delete" />删除</span>
            </el-col>
          </el-row>
        </el-header>
        <el-main>
