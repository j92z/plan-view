            ...
            <el-col :span="1" :offset="15">
              <el-dropdown trigger="click">
                <span class="el-dropdown-link" style="font-size: 30px">
                  <i class="el-icon-s-operation" title="操作"></i>
                </span>
                <el-dropdown-menu slot="dropdown">
                  <el-dropdown-item><i class="el-icon-edit" />编辑</el-dropdown-item>
                  <el-dropdown-item v-if="children.length === 0" @click="deletePlan(id)"><i class="el-icon-delete" />删除</el-dropdown-item>
                  <el-dropdown-item v-else disabled><i class="el-icon-delete" />删除</el-dropdown-item>
                </el-dropdown-menu>
              </el-dropdown>
            </el-col>
          </el-row>
                    ...
                    <el-card shadow="always">
                      <el-container>
                        <el-header height="30px">
                          <el-row>
                            <el-col :span="22">
                              <span style="font-size: 30px;cursor: pointer;white-space: nowrap;overflow: hidden;text-overflow: ellipsis;" @click="goToDetail(item.id)">
                                {{ item.name }}
                              </span>
                            ...
                            <el-col :span="2">
                              <el-dropdown trigger="click">
                                ...
                                <el-dropdown-menu slot="dropdown">
                                  <el-dropdown-item @click="deletePlan(item.id)"><i class="el-icon-delete" />删除</el-dropdown-item>
                                </el-dropdown-menu>
                              </el-dropdown>
                            </el-col>
                          </el-row>
