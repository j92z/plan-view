          ...
          <el-form label-position="left" >
            ...
            <el-form-item label="状态">
              <span style="font-size: 30px">
                <i v-if="status===2" class="el-icon-finished" style="color: green;">(已完成)</i>
                <i v-else-if="status===-1" class="el-icon-close" style="color: red">(失败)</i>
                <i v-else class="el-icon-truck">(进行中)</i>
              </span>
            </el-form-item>
