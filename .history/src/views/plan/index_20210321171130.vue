                ...
                <el-card v-if="item.children.length > 0" shadow="hover" style="margin-top: 10px">
                  ...
                  <el-row v-for="child in item.children" :key="child.id">
                    ...
                    <el-col :span="2" :offset="14">
                      <i class="el-icon-finished" style="color: green" v-if="child.status===2"></i>
                      <i class="el-icon-close" style="color: red" v-else-if="child.status===-1"></i>
                      <i class="el-icon-truck" v-else></i>
                    </el-col>
                  </el-row>
                </el-card>
              </el-main>
