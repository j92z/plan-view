      ...
      >
        <template>
          <el-form ref="form" :model="form" label-width="80px" style="padding: 20px">
            ...
            <el-form-item>
              <el-button v-if="id.length > 0" :loading="formLoading" type="primary" @click="addPlan">立即创建</el-button>
  ...
  methods: {
    ...
    openPlanDetail(id) {
      getOnePlan(id).then((response) => {
        ...
        this.form.parent = response.data.parent.length > 0 ? [response.data.parent] : []
