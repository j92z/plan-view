              ...
              <el-header height="30px">
                <el-row>
                  ...
                  <el-col :span="2" :offset="6" style="font-size: 30px">
                    <i v-if="item.status===2" class="el-icon-finished" style="color: green;"/>
                    <i v-else-if="item.status===-1" class="el-icon-close" style="color: red" />
                    <i v-else class="el-icon-truck" style=""/>
                  </el-col>
                </el-row>
              </el-header>
              <el-main>
                <span>{{ item.content }}</span>
                <el-card v-if="item.children.length > 0" shadow="hover" style="margin-top: 10px">
                  <el-row style="margin-bottom: 10px"><span style="font-size: 20px;">目标达成</span></el-row>
                  <el-row v-for="child in item.children" :key="child.id" style="font-size: 14px">
                    <el-col :span="8">{{ child.name }}</el-col>
                    <el-col :span="2" :offset="14">
                      <i v-if="child.status===2" class="el-icon-finished" style="color: green" />
                      <i v-else-if="child.status===-1" class="el-icon-close" style="color: red" />
