      ...
      <el-container>
        <el-header style="font-size: 30px">
          <el-row :gutter="20">
            ...
            <el-col :span="1" :offset="14" style="font-size: 30px">
              <span><i class="el-icon-edit" :command="edit" /></span>
            </el-col>
            <el-col :span="1" style="font-size: 30px">
              <span v-if="children.length === 0" ><i class="el-icon-delete" /></span>
              <span v-else style="color: gray"><i class="el-icon-delete" /></span>
            </el-col>
          </el-row>
        </el-header>
        <el-main>
