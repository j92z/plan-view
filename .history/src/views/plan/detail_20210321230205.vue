            ...
            <el-col :span="1" :offset="15">
              <el-dropdown trigger="click" @command="handleCommand">
                ...
                <el-dropdown-menu slot="dropdown">
                  <el-dropdown-item><i class="el-icon-edit" command="edit" />编辑</el-dropdown-item>
                  <el-dropdown-item v-if="children.length === 0" :command="'delete,'+id"><i class="el-icon-delete" />删除</el-dropdown-item>
