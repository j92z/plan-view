<template>
  <div class="app-container">
    ...
    <template>
      <el-row :gutter="12">
        <el-col v-for="item in list" :key="item.id" :span="8" style="margin: 20px 0;">
...
<script>
import { getTree, addPlan, getOnePlan, updatePlan, removePlan, getFirstLevelPlan } from '@/api/plan'
