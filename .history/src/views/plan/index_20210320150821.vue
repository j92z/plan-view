  ...
  <div class="app-container">
    ...
    >
      ...
      <el-table-column align="center" label="action" width="100">
        <template slot-scope="scope">
          <el-button :ref="'del_btn_' + scope.row.id" type="danger" icon="el-icon-delete" @click="deletePlan(scope.row.id)">删除</el-button>
        </template>
      </el-table-column>
    </el-table>
    <template>
...
export default {
  ...
  methods: {
    ...
    deletePlan(id) {
      this.$refs['del_btn_'+id].this.$refs['del_btn_'+id].loading = true
      console.log(this.$refs['del_btn_'+id].loading)
